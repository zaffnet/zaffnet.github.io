...
<!-- markdownlint-disable MD022 MD033 MD051 -->
<!-- Kramdown {: #id } heading IALs below define real anchors (verified in the
     built HTML), but markdownlint doesn't parse Kramdown IAL syntax, so it
     misreports missing blank lines after headings and broken link fragments.
     figure/figcaption/img/strong tags are needed for the figure/figcaption
     CSS in _sass/minima/_base.scss, which has no Markdown equivalent. -->
...
- [Background](#intro)
  - [Why is normalization important?](#normalization)
...
<figure>
  <img src="/assets/batchnorm/batchnorm.jpg" alt="Flow of computation through Batch Normalization layer">
  <figcaption><strong>Fig 1.</strong> Flow of computation through Batch Normalization layer</figcaption>
</figure>
...
<figure>
  <img src="/assets/batchnorm/accuracy.jpg" alt="Training and Validation accuracy vs. number of epochs">
  <figcaption><strong>Fig 2.</strong> Training and Validation accuracy vs. number of epochs</figcaption>
</figure>
...
<figure>
  <img src="/assets/batchnorm/init.jpg" alt="Training and Validation accuracy vs. weight initialization scale">
  <figcaption><strong>Fig 2.</strong> Training and Validation accuracy vs. weight initialization scale</figcaption>
</figure>
