...
The updated diagram mirrors the paper: collect contrastive prompts, fit a logistic-regression probe on frozen activations, then reuse the same vector for monitoring, mitigation, and data flagging.
